...
public class ChiTietBangLuongCongNhan extends javax.swing.JPanel {
	...
	private void themSuKien() {
		...
		if(dsbangChamCongCongNhan != null) {
...
//			tongTien += tienTangCa;
			try {
			 ...
			 jLabel1.setText("CHI TIẾT LƯƠNG CÔNG NHÂN TRONG THÁNG  " + (bangChamCongCongNhan.getNgayChamCong().getMonth() + 1) + "/" +  (bangChamCongCongNhan.getNgayChamCong().getYear() + 1900));
